...
const PaginatedTable = ({ columns, data, itemsPerPage = 6, searchProperty }) => {
  ...
  const filteredData = data.filter(row => {
    const cellValue = row[searchProperty]?.toString().toLowerCase(); // Asegúrate de que row[searchProperty] es una cadena
